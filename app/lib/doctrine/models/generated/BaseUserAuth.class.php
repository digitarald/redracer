 ...
 */
abstract class BaseUserAuth extends RedRacerDoctrineRecord
{
  public function setTableDefinition()
  {
    $this->setTableName('user_auths');
    $this->hasColumn('id', 'integer', 4, array('type' => 'integer', 'primary' => true, 'autoincrement' => true, 'unsigned' => true, 'length' => '4'));
    $this->hasColumn('identifier', 'string', 250, array('type' => 'string', 'unique' => true, 'length' => '250'));
